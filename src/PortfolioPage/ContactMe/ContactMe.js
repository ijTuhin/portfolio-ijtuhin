                ...
                <div className='md:block hidden'>
                    ...
                    <div className='w-[600px] mt-8'>
                        <div className='grid grid-cols-2 mb-6'>
                            <input placeholder='Your Name' className='form-control bg-transparent placeholder-gray-600 text-gray-200 border-b border-gray-300 p-2 w-[275px]' {...register("name")} />
                            <input placeholder='Email Address' className='form-control bg-transparent placeholder-gray-600 text-gray-200 border-b border-gray-300 p-2 w-[275px]' {...register("email")} /> <br />
                        </div>
                    </div>
                    <textarea className="form-control bg-transparent placeholder-gray-600 text-gray-200 border-b border-gray-300 mb-2 p-2 w-[580px]" placeholder='Hi, we have a project "X" at our company "Y". How soon can you hop on to discuss this? ' rows="2" {...register("feedback")} />
