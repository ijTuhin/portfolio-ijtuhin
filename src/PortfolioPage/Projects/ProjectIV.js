...
import { projectIV1, projectIV2, projectIV3 } from '../../index';
    ...
    return (
        <div className='bg-gray-800 text-gray-500'>
            ...
            <div className='absolute top-3 right-0 font-mono'>
                <a className='mr-4 hover:font-medium hover:text-cyan-600' href="https://catering-service-provider.web.app/" target='_blank' rel='noreferrer'>Website</a>
                <a className='mr-4 hover:font-medium hover:text-cyan-600' href="https://github.com/programming-hero-web-course-4/independent-service-provider-ijTuhin" target='_blank' rel='noreferrer'>Git-Client</a>
            ...
            <div className='flex flex-col justify-center items-center w-screen h-screen detail'>
                <div className='flex justify-center mb-5 detail-header w-full'>
                    ...
                    <h1 className='text-gray-500 md:text-2xl text-2xl font-medium font-serif'>Foodie Food Catering Service</h1>
                    <span className='border-b-2 border-gray-600 md:w-20 w-14 mt-2.5 mx-2 h-2'></span>
                </div>
                <div className='border-2 border-gray-500 mx-20 p-2 details-box hover:border-gray-500'>
                    <div className='flex justify-center items-center'>
                        <div><img className='w-72 h-44 m-2' src={projectIV1} alt="" /></div>
                        <div><img className='w-72 h-44 m-2' src={projectIV2} alt="" /></div>
                        <div><img className='w-72 h-44 m-2' src={projectIV3} alt="" /></div>
                    </div>
