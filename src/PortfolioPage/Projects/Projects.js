...
const Projects = () => {
    return (
        <div className='flex flex-col justify-center items-center'>
            ...
            <div className='grid md:grid-cols-3 grid-cols-1 gap-x-5 gap-y-14 cards mt-2'>
                <div className="w-[350px] h-52 text-center flex flex-col items-center justify-center">
