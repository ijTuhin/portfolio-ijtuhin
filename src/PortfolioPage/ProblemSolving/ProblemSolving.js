...
const ProblemSolving = () => {
    return (
        <div className='w-screen flex justify-center mt-64 mb-10'>
            <div className='grid grid-cols-1 md:flex md:border md:border-gray-600 md:border-l-0 md:border-r-0 py-5 md:w-[68rem]'>
